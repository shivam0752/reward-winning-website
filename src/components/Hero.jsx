...
const Hero = () => {
  ...
  const totalVideos = 4;
  const nextVideoRef = useRef(null); // useRef is used to when you want to select a specific DOM element
  ...
  return (
    <div className='relative h-dvh w-screen overflow-x-hidden'>
      ...
      {isLoading && (
        <div className='flex-center overflow-hidden bg-violet-50 absolute z-[100] h-dvh w-screen'>
        ...
        <div>
          <div className='mask-clip-path absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg'>
            ...
            className='origin-center scale-50 opacity-0 transition-all duration-500 ease-in hover:scale-100 hover:opacity-100' >
              <video ref={nextVideoRef} src= {getVideoSource(upcomingVideoIndex)}
              loop
              muted
              id='current-video'
              className='scale-150 object-center object-cover size-64 origin-center'
